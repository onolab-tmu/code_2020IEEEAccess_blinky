...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "protocol", type=str, help="The JSON file containing the experimental details."
    )
    parser.add_argument(
        "configs",
        metavar="CONFIG",
    ...
    sns.catplot(data=df, x="Algorithm", y="Error", col="Set", kind="box")
    plt.ylim([0, 200])

    if not os.path.exists(FIGURE_FOLDER):
        os.mkdir(FIGURE_FOLDER)

    plt.savefig(os.path.join(FIGURE_FOLDER, "mse.pdf"))
